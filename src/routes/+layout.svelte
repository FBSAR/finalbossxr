      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
          ...
          <span class="text-gray-500 text-sm flex items-center gap-1">
            Made with <span class="text-red-500 animate-pulse">❤️</span> by <a href="https://www.linkedin.com/in/eddietaliaferrojr/" target="_blank" rel="noopener noreferrer" class="text-[#FFD700] hover:text-[#00ff00] transition-colors font-medium">Eddie Taliaferro II</a>, CEO
          </span>
        </div>
